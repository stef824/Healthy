...
public class RecipeCollectionActivity extends AppCompatActivity {
    @ViewInject(R.id.toolbar_collection)
    private Toolbar mToolbar;
    @ViewInject(R.id.rv_collections)
        ...
        protected void onPostExecute(final List<Integer> newsIds) {
                    ...
                    ApiStoreSDK.execute(ConstantFactory.getNewsUrl(newsIds.get(i)), ApiStoreSDK.GET, null, new ApiCallBack() {
                        ...
                        public void onSuccess(int i, String s) {
                            ...
                            if (commonResponse.isStatus()) {
                                ...
                                Intent intent = new Intent(RecipeCollectionActivity.this, NewsDetailActivity.class);
            ...
            mAdapter.setOnRecyclerViewItemLongClickListener(new BaseQuickAdapter.OnRecyclerViewItemLongClickListener() {
                ...
                public boolean onItemLongClick(View view, final int i) {
                    ...
                    if (mDialog == null) {
                        AlertDialog.Builder builder = new AlertDialog.Builder(RecipeCollectionActivity.this);
            ...
            mLayoutManager = new GridLayoutManager(RecipeCollectionActivity.this, 2);
